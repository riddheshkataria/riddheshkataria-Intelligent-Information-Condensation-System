...
import { uploadDoc, getDocs, getDocById, searchDocs, shareDocument, getDocumentFile, archiveDocument } from '../controllers/docController.js'
...
// ADD THIS NEW ROUTE
// @route   POST /api/docs/:id/archive
