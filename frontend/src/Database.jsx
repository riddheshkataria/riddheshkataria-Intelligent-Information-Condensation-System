...
const Header = ({ currentLang, toggleLanguage }) => ( <header className="page-header"> <img src="/logo.png" alt="KMRL SAARAM Logo" className="logo" /> <div className="header-middle"> <div className="search-bar-header"> <SearchIcon /> <input type="text" placeholder="Search..." /> </div> </div> <div className="header-controls"> <button className="lang-btn-header" onClick={toggleLanguage}> <span>{currentLang === 'english' ? 'English' : 'മലയാളം'}</span> <TranslateIcon /> </button> <div className="user-profile"> <UserIcon /> </div> </div> </header> );
...
const Footer = () => ( <footer className="page-footer"> <div className="footer-content"> <div className="footer-logo-section"> <img src="/logo.png" alt="KMRL SAARAM Logo" className="footer-logo" /> </div> <div className="footer-section"> <h4>Contact Us</h4> <p><PhoneIcon />+91 0000000000 / +91 0000000000</p> <p><MailIcon />project@kmrl.com</p> </div> <div className="footer-section"> <h4>Address</h4> <p><MapPinIcon />Kochi Metro Rail Ltd. (KMRL), 4th Floor, Revenue Tower, Park Avenue, Kochi - 682011, Kerala, India.</p> </div> <div className="footer-social"> <h4>Follow Us</h4> <div className="social-icons"> <FacebookIcon /> <InstagramIcon /> <XIcon /> <LinkedinIcon /> <YoutubeIcon /> </div> </div> </div> </footer> );
